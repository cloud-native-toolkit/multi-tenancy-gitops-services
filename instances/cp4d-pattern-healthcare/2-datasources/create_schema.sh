                        command="\
                                curl -O -L https://raw.githubusercontent.com/cp4d-demo/multi-tenancy-gitops-services/master/instances/cp4d-pattern-healthcare/2-datasources/patients.csv; \
                                curl -O -L https://raw.githubusercontent.com/cp4d-demo/multi-tenancy-gitops-services/master/instances/cp4d-pattern-healthcare/2-datasources/encounters.csv; \
                                curl -O -L https://raw.githubusercontent.com/cp4d-demo/multi-tenancy-gitops-services/master/instances/cp4d-pattern-healthcare/2-datasources/conditions.csv; \
