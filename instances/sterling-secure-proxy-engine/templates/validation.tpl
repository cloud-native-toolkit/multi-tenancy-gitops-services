...
{{- $result := include "mandatoryArgumentsCheck" .Values.engineArgs.keyCertAliasName -}}
{{- if eq $result "false" -}}
{{- fail "Configuration Missing: Please provide valid value for Values.engineArgs.keyCertAliasName" -}}
{{- end -}}

{{- $result := include "mandatoryArgumentsCheck" .Values.service.engine.containerPort -}}
{{- if eq $result "false" -}}
{{- fail "Configuration Missing: Please provide valid value for Values.service.engine.containerPort" -}}
{{- end -}}
