...
*/
{{- define "ibm-ssp-engine.nodeAffinity" }}
{{- $rootCtx := index . 0 }}
{{- $currNodeAffinity := index . 1 }}
{{- $archRequiredMatchExpressions := include "ibm-ssp-engine.nodeAffinityArchRequired.matchExpressions" $rootCtx }}
nodeAffinity:
...
*/
{{- define "ibm-ssp-engine.nodeAffinityArchRequired.matchExpressions" }}
...
/*
  Pod affinity
*/
{{- define "ibm-ssp-engine.podAffinity" }}
{{- $rootCtx := index . 0 }}
...
/* 
  Pod Anti Affinity
*/
{{- define "ibm-ssp-engine.podAntiAffinity" }}
{{- $rootCtx := index . 0 }}
